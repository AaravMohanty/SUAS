...
if __name__ == "__main__":
    def dir_to_photo():
        global images
        after = dict([(f, f) for f in os.listdir("/Users/jeffrey/Documents/ImageLabeling")])
    ...
    def next_image():
        ...
        if len(qimage) == 1:
            ...
            app.set_image("/Users/jeffrey/Documents/ImageLabeling/" + coord_from_image(qimage.pop(1)))
    ...
    qimage = [f for f in os.listdir("/Users/jeffrey/Documents/ImageLabeling")]
